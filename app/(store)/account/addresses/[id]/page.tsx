...
export default function EditAddressPage({ params }: EditAddressPageProps) {
  ...
  if (initialLoading) {
    return (
      <div className="min-h-screen py-8 flex items-center justify-center" style={{ background: "#FAFAF8" }}>
        <Loader2 className="w-6 h-6 animate-spin" style={{ color: "#7B9E6B" }} />
      </div>
    );
  }
    ...
    <div className="min-h-screen py-8" style={{ background: "#FAFAF8" }}>
      <div className="max-w-xl mx-auto px-4">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <h1 className="text-xl font-bold" style={{ fontFamily: "var(--font-rajdhani,'Rajdhani',sans-serif)", color: "#1a1a1a" }}>Edit Address</h1>
        </div>
