  ...
  return (
    <div className="min-h-screen py-8" style={{ background: "#FAFAF8" }}>
      <div className="max-w-2xl mx-auto px-4">
        ...
        {/* Items */}
        <div className="bg-white border p-4 mb-4" style={{ borderColor: "rgba(46,125,50,0.15)" }}>
          ...
          <div className="space-y-4">
            {order.items.map((item: typeof order.items[number]) => (
              <div key={item.id} className="flex items-center gap-4">
                <div className="w-14 h-14 flex-shrink-0 flex items-center justify-center" style={{ background: "#FAFAF8", border: "1px solid rgba(46,125,50,0.15)" }}>
          ...
          <div className="space-y-2 text-sm">
            ...
            {order.discount > 0 && (
              <div className="flex justify-between">
                ...
                <span style={{ color: "#2E7D32" }}>-{formatCurrency(order.discount)}</span>
              </div>
            )}
            <Separator />
        ...
        {/* Payment & Tracking */}
        <div className="bg-white border p-4 mb-4 space-y-4" style={{ borderColor: "rgba(46,125,50,0.15)" }}>
          ...
          {(order.status === "SHIPPED" || order.status === "DELIVERED") && (
            <>
              <div className="flex items-center gap-2 mt-4 pt-4 border-t" style={{ borderColor: "rgba(46,125,50,0.15)" }}>
