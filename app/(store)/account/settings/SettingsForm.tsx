  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8] py-8">
      <div className="max-w-2xl mx-auto px-4">
        <Link href="/account" className="inline-flex items-center gap-2 text-sm text-[#7B9E6B] hover:text-[#14532D] mb-6">
          <ArrowLeft className="w-4 h-4" />
          Back to Account
        </Link>

        <div className="bg-white border border-[rgba(20,83,45,0.15)] p-6 rounded-lg shadow-[0_2px_8px_rgba(20,83,45,0.06)]">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="border-[rgba(20,83,45,0.15)] focus:border-[#14532D] bg-white text-[#1a1a1a]"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                disabled
                className="border-[rgba(20,83,45,0.15)] bg-white text-[#7B9E6B]"
              />
              <p className="text-xs text-[#7B9E6B]">Email cannot be changed</p>
            </div>

            <div className="pt-4 border-t border-[rgba(20,83,45,0.15)]">
            ...
            <div className="flex justify-end">
              <Button type="submit" disabled={isLoading} className="bg-[#14532D] hover:bg-[#0F3D20] text-white">
                {isLoading ? "Saving..." : "Save Changes"}
              </Button>
            </div>
          </form>

          <div className="mt-8 pt-6 border-t border-[rgba(20,83,45,0.15)]">
