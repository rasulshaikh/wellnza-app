        ...
        >
          ...
          <div
            style={{
              ...
              marginTop: "16px",
              paddingTop: "32px",
              borderTop: "1px solid rgba(20, 83, 45, 0.15)",
              justifyContent: "center",
            }}
        ...
        >
          ...
          <div
            style={{
              ...
              borderRadius: "50%",
              background:
                "linear-gradient(135deg, rgba(20, 83, 45, 0.08) 0%, rgba(20, 83, 45, 0.03) 100%)",
              display: "flex",
              justifyContent: "center",
              alignItems: "center",
              position: "relative",
          ...
          >
            ...
            >
              ...
              {/* Decorative dots */}
              <circle cx="150" cy="180" r="4" fill="#14532D" fillOpacity="0.3" />
              <circle cx="150" cy="220" r="3" fill="#14532D" fillOpacity="0.25" />
              <circle cx="150" cy="280" r="3.5" fill="#14532D" fillOpacity="0.2" />
